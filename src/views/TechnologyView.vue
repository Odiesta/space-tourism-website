...
<template>
  <div
    class="min-h-screen w-full bg-cover bg-center bg-no-repeat bg-[url('@/assets/technology/background-technology-mobile.jpg')]"
  >
    <NavigationMenu />
    <h2
      class="text-white font-barlow-condensed uppercase text-center tracking-[2.7px]"
    >
      <span class="opacity-25 mr-4 font-bold">03</span> Space Launch 101
    </h2>
    ...
    >
      <img
        :src="store.currentTechnology?.image"
    ...
    <div class="max-w-md text-center lg:text-left px-8 py-6">
      ...
      <h2
        class="text-white text-[24px] lg:text-[100px] font-bellefair uppercase mt-2 tracking-wide"
      >
